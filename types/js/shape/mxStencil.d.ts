...
declare class mxStencil {
	 ...
	 */
	static defaultLocalized: boolean; //false;
	 ...
	 */
	constraints: mxConnectionConstraint[]; //null
	 ...
	 */
	parseConstraint(node): mxConnectionConstraint;
	// {
	 ...
	 */
	drawShape(canvas: mxAbstractCanvas2D, shape, x: number, y: number, w: number, h: number): void;
	// {
	 ...
	 * Draws this stencil inside the given bounds.
	 */
	drawChildren(canvas: mxAbstractCanvas2D, shape, x: number, y: number, w: number, h: number, node, aspect, disableShadow): void;
	// {
	 ...
	 */
	computeAspect(shape: mxShape, x: number, y: number, w: number, h: number, direction): mxRectangle;
	// {
	// 	var x0 = x;
	// 	var y0 = y;
	// 	var sx = w / this.w0;
	 ...
	 * Draws this stencil inside the given bounds.
	 */
	drawNode(canvas: mxAbstractCanvas2D, shape: mxShape, node, aspect, disableShadow: boolean): void;
	// {
