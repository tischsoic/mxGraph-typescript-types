...
declare class mxSwimlane extends mxShape {
	 ...
	 * Paints the swimlane vertex shape.
	 */
	paintSwimlane(c: mxAbstractCanvas2D, x: number, y: number, w: number, h: number, start, fill: string, swimlaneLine): void;
	// {
	 ...
	 * Paints the swimlane vertex shape.
	 */
	paintRoundedSwimlane(c: mxAbstractCanvas2D, x: number, y: number, w: number, h: number, start, r, fill: string, swimlaneLine): void;
	// {
	// 	if (fill != mxConstants.NONE)
	// 	{
	// 		c.save();
