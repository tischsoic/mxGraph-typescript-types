...
declare class mxArrowConnector extends mxShape {
	 ...
	 * Paints the line shape.
	 */
	paintMarker(c: mxAbstractCanvas2D, ptX: number, ptY: number, nx: number, ny: number, 
		size: number, arrowWidth: number, edgeWidth: number, spacing: number, initialMove: boolean): void;
	// {
