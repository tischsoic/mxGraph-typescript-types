...
declare class mxGraph extends mxEventSource {
	...
	* stylesheet - Optional <mxStylesheet> to be used in the graph.
	*/
	constructor(container?: Node, model?: mxGraphModel, renderHint?: string, stylesheet?: mxStylesheet)
	// {
 ...
 */
	...
	getRemovedCellsForChanges(changes: mxChange[]): mxCell[];
	// {
	// 	var result = [];
	...
	processChange(change: mxChange): void;
	// {
	// 	// Resets the view settings, removes all cells and clears
	// 	// the selection if the root changes.
	// 	if (change instanceof mxRootChange)
	 ...
	 * Default is false.
	 */
	insertVertex(parent: mxCell, id: string, value: object,
