...
declare class mxCellEditor {
	 ...
	 */
	wordWrapPadding: number; //(mxClient.IS_QUIRKS) ? 2 : (!mxClient.IS_IE11) ? 1 : 0
	 ...
	 */
	getInitialValue(state, trigger): string;
	// {
	 ...
	 */
	isStopEditingEvent(evt): boolean;
	// {
	 ...
	 */
	startEditing(cell: mxCell, trigger?): void;
	// {
	// 	this.stopEditing(true);
