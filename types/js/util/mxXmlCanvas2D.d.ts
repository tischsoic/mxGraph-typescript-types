...
declare class mxXmlCanvas2D extends mxAbstractCanvas2D {
	 ...
	 */
	setFillColor(value: string | 'none'): void;
	// {
	 ...
	 * value - Hexadecimal representation of the color or 'none'.
	 */
	setStrokeColor(value: string | 'none'): void;
	// {
	// 	if (value == mxConstants.NONE)
	// 	{
	// 		value = null;
	 ...
	 * value - Hexadecimal representation of the color or 'none'.
	 */
	setFontColor(value: string | 'none'): void;
	// {
	// 	if (this.textEnabled)
	// 	{
	// 		if (value == mxConstants.NONE)
	 ...
	 * value - Hexadecimal representation of the color or 'none'.
	 */
	setFontBackgroundColor(value: string | 'none'): void;
	// {
	// 	if (this.textEnabled)
	// 	{
	// 		if (value == mxConstants.NONE)
	 ...
	 * value - Hexadecimal representation of the color or 'none'.
	 */
	setFontBorderColor(value: string | 'none'): void;
	// {
	// 	if (this.textEnabled)
	// 	{
	// 		if (value == mxConstants.NONE)
	 ...
	 * value - Hexadecimal representation of the color or 'none'.
	 */
	setShadowColor(value: string | 'none'): void;
	// {
	// 	if (this.compressed)
	// 	{
	// 		if (value == mxConstants.NONE)
