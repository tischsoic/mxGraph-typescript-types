type overflow = 'visible' | 'hidden' | 'fill' | 'width';
type text_direction = '' | 'auto' | 'ltr' | 'rtl';
type mxConstants_align = 'left' | 'center' | 'right' | 'top' | 'middle' | 'bottom';
type mxConstants_direction = 'north' | 'south' | 'east' | 'west';
