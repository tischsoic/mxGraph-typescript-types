...
declare class mxVmlCanvas2D extends mxAbstractCanvas2D {
	constructor(root); //var mxVmlCanvas2D = function(root)
	// {
	 ...
	 */
	createDiv(str: string, align, valign, overflow);
	// {
	 ...
	 */
	plainText(x: number, y: number, w: number, h: number, str: string, align, valign, wrap: boolean, format: '' | 'html', overflow, clip: boolean, rotation: number, dir: text_direction): void;
	// {
