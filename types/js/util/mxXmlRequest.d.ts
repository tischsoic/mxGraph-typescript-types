...
declare class mxXmlRequest {
	constructor(url: string | null, params: string | null, method?: 'POST' | 'GET' | null, async?: boolean, username: string, password: string);
	// {
	// 	this.url = url;
	// 	this.params = params;
	 ...
	 */
	create(): XMLHttpRequest | ActiveXObject;
	// {
	 ...
	 */
	send(onload: (ob: mxXmlRequest) => any, onerror, timeout: number, ontimeout): void;
	// {
	 ...
	 */
	setRequestHeaders(request, params): void;
	// {
	// 	if (params != null)
	// 	{
