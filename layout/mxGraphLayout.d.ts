 ...
 */
execute(parent: mxCell, root?: mxCell): void; // root added because of mxCompactTreeLayout
// { };
 ...
 */
traverse(vertex: mxCell, directed?: boolean, func?, edge?: mxCell, visited?: mxDictionary): void;
// {
 ...
 */
setEdgeStyleEnabled(edge: mxCell, value): void;
// {
 ...
 */
setOrthogonalEdge(edge: mxCell, value): void;
// {
 ...
 * of the layout
 */
getParentOffset(parent): mxPoint;
// {
 ...
 */
setEdgePoints(edge: mxCell, points: mxPoint[]): void;
// {
// 	if (edge != null)
// 	{
