 ...
 */
moveNode(node, dx: number, dy: number): void;
// {
// 	node.x += dx;
// 	node.y += dy;
// 	this.apply(node);
 ...
 */
sortOutgoingEdges(source, edges: mxCell[]);
// {
 ...
 */
setCellHeights(node: Object, rank);
// {
// 	if (this.maxRankHeight[rank] != null && this.maxRankHeight[rank] > node.height)
// 	{
 ...
 */
horizontalLayout(node, x0: number, y0: number, bounds);
// {
 ...
 */
attachParent(node, height: number): void;
// {
