 ...
 */
export type mxMarker_function = (canvas, shape, type, pe, unitX, unitY, size, source, sw, filled) => (() => void);

export interface mxMarker
{
	/**
	 * Class: mxMarker
	 * 
	 ...
	 */
	addMarker(type: string, funct: mxMarker_function);
	// {
	 ...
	 */
	createMarker(canvas, shape, type: string, pe, unitX: number, unitY: number, size: number, source, sw, filled: boolean);
	// {
