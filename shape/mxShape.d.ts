...
export class mxShape {
	 ...
	 */
	dialect: mxConstants_dialect; //null
	 ...
	 */
	createCanvas(): mxSvgCanvas2D | mxVmlCanvas2D | null;
	// {
	// 	var canvas = null;
	 ...
	 */
	destroyCanvas(canvas: mxAbstractCanvas2D): void;
	// {
	 ...
	 */
	paint(c: mxAbstractCanvas2D, update?: boolean): void; // update because of mxText
	// {
	 ...
	 */
	getArcSize(w: number, h: number, start?: number): number; // start because of mxSwimlane
	// {
	 ...
	 */
	addPoints(c: mxAbstractCanvas2D, pts: mxPoint[], rounded: boolean, arcSize: number, close: boolean): void;
	// {
	 ...
	 */
	setTransparentBackgroundImage(node): void;
	// {
	 ...
	 * Paints the line shape.
	 */
	releaseSvgGradients(grads): void;
	// {
	// 	if (grads != null)
	// 	{
