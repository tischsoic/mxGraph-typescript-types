declare module "mxgraphAllClasses" {
	...
	export class mxImageExport {
		 ...
		 * Draws the given state and all its descendants to the given canvas.
		 */
		visitStatesRecursive(state: mxCellState, canvas: mxAbstractCanvas2D, visitor: (state: mxCellState, canvas: mxAbstractCanvas2D) => any): void;
		// {
		// 	if (state != null)
		// 	{
		 ...
		 */
		getLinkForCellState(state: mxCellState, canvas: mxAbstractCanvas2D): null;
		// {
		// 	return null;
		// };
