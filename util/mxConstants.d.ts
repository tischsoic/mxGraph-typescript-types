declare module "mxgraphAllClasses" {
	...
	export type overflow = 'visible' | 'hidden' | 'fill' | 'width';
	export type text_direction = '' | 'auto' | 'ltr' | 'rtl';
	export type mxConstants_align = 'left' | 'center' | 'right' | 'top' | 'middle' | 'bottom';
	export type mxConstants_direction = 'north' | 'south' | 'east' | 'west';
	export type mxConstants_dialect = 'svg' | 'vml' | 'mixedHtml' | 'preferHtml' | 'strictHtml';
	...
	export interface mxConstants {
		 ...
		 */
		OUTLINE_STROKEWIDTH: number; //(mxClient.IS_IE) ? 2 : 3,
		 ...
		 */
		PAGE_FORMAT_A4_PORTRAIT: mxRectangle; //new mxRectangle(0, 0, 826, 1169),
		 ...
		 * of this page format are 826x1169 pixels.
		 */
		PAGE_FORMAT_A4_LANDSCAPE: mxRectangle; //new mxRectangle(0, 0, 1169, 826),
		 ...
		 */
		PAGE_FORMAT_LETTER_PORTRAIT: mxRectangle; //new mxRectangle(0, 0, 850, 1100),
		 ...
		 */
		PAGE_FORMAT_LETTER_LANDSCAPE: mxRectangle; //new mxRectangle(0, 0, 1100, 850),
