declare module "mxgraphAllClasses" {
	...
	export class mxEventSource {
		 ...
		 */
		// TO DO
		// string for listener name
		// any for listener in future it should be changed to interface?
		eventListeners: [string | any];
		 ...
		 */
		// TO DO
		// Is name always string?
		// change funct time to some interface
