declare module "mxgraphAllClasses" {
	...
	export class mxSvgCanvas2D extends mxAbstractCanvas2D {
		constructor(root, styleEnabled?: boolean);
		// {
		 ...
		 */
		createStyle(x): HTMLStyleElement;
		// {
		 ...
		 */
		// TO DO
		// is fo a foAltText ???? WTF mxGRaph?
		createAlternateContent(fo, x: number, y: number, w: number, h: number, str: string, align: string, valign: string, wrap, format, overflow, clip, rotation);
		// {
		 ...
		 * Private helper function to create SVG elements
		 */
		createGradientId(start: string, end: string, alpha1: number, alpha2: number, direction: mxConstants_direction);
		// {
		 ...
		 * Private helper function to create SVG elements
		 */
		getSvgGradient(start: string, end: string, alpha1: number, alpha2: number, direction: mxConstants_direction);
		// {
		 ...
		 */
		createSvgGradient(start: string, end: string, alpha1: number, alpha2: number, direction: mxConstants_direction);
		// {
		 ...
		 * Private helper function to create SVG elements
		 */
		image(x: number, y: number, w: number, h: number, src, aspect: boolean, flipH: boolean, flipV: boolean): void;
		// {
		 ...
		 * Private helper function to create SVG elements
		 */
		createDiv(str: string, align, valign, style: string, overflow);
		// {
		// 	var s = this.state;
		 ...
		 */
		updateText(x: number, y: number, w: number, h: number, align, valign, wrap: boolean, overflow, clip: boolean, rotation: number, node: Node): void;
		// {
		 ...
		 */
		text(x: number, y: number, w: number, h: number, str: string, align, valign, wrap: boolean, format: '' | 'html', overflow, clip: boolean, rotation: number, dir: text_direction): void;
		// {
		 ...
		 */
		plainText(x: number, y: number, w: number, h: number, str: string, align, valign, wrap: boolean, overflow, clip: boolean, rotation: number, dir: text_direction): void;
		// {
		// 	rotation = (rotation != null) ? rotation : 0;
		// 	var s = this.state;
		// 	var size = s.fontSize;
		 ...
		 */
		addTextBackground(node: Node, str: string, x: number, y: number, w: number, h: number, align, valign, overflow): void;
		// {
		// 	var s = this.state;
