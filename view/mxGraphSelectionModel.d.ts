...
export class mxGraphSelectionModel extends mxEventSource {
	 ...
	 */
	updatingSelectionResource: string; //(mxClient.language != 'none') ? 'updatingSelection' : ''
	 ...
	 * cell - <mxCell> to add to the selection.
	 */
	changeSelection(added, removed): void;
	// {
	// 	if ((added != null &&
	// 		added.length > 0 &&
	// 		added[0] != null) ||
	 ...
	 */
	mxSelectionChange(selectionModel: mxGraphSelectionModel, added, removed): void
	// {
