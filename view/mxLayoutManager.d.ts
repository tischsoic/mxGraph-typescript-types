...
export class mxLayoutManager extends mxEventSource {
	 ...
	 */
	// TO DO
	// why in comments parameters are sooo different???
	beforeUndo(undoableEdit): void;
	// {
	 ...
	 * evt - Mouse event that represents the mousedown.
	 */
	cellsMoved(cells: mxCell[], evt): void;
	// {
	 ...
	 */
	getCellsForChanges(changes): mxCell[];
	// {
	 ...
	 * Executes the given layout on the given parent.
	 */
	executeLayout(layout, parent): boolean;
	// {
	// 	var result = false;
