...
export class mxCellRenderer {
	 ...
	 */
	defaultEdgeShape: mxConnector; //mxConnector
	 ...
	 */
	defaultVertexShape: mxRectangleShape; //mxRectangleShape
	 ...
	 */
	defaultTextShape: mxText; //mxText
	 ...
	 */
	registerShape(key: string, shape);
	// {
	 ...
	 * state - <mxCellState> for which the label should be created.
	 */
	createLabel(state: mxCellState, value): void;
	// {
	// 	var graph = state.view.graph;
	 ...
	 */
	initializeLabel(state: mxCellState, shape): void;
	// {
	 ...
	 */
	installCellOverlayListeners(state: mxCellState, overlay: mxImageShape, shape: mxShape): void;
	// {
	// 	var graph  = state.view.graph;
	 ...
	 */
	createControlClickHandler(state: mxCellState);
	// {
	// 	var graph = state.view.graph;
	 ...
	 */
	initControl(state: mxCellState, control: mxShape, handleEvents: boolean, clickHandler?): Node;
	// {
	// 	var graph = state.view.graph;
	 ...
	 */
	isShapeEvent(state: mxCellState, evt): boolean;
	// {
	// 	return true;
	// };
	 ...
	 * evt - Mouse event which was fired.
	 */
	isLabelEvent(state: mxCellState, evt): boolean;
	// {
	// 	return true;
	// };
	 ...
	 */
	insertStateAfter(state: mxCellState, node, htmlNode);
	// {
	 ...
	 */
	getShapesForState(state: mxCellState);
	// {
