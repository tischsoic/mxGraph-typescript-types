declare module "mxgraphAllClasses" {
	interface mxCellOverlayConstructor {
		new (image: mxImage, tooltip?: string, 
			align?: 'left' | 'center' | 'right', 
			verticalAlign?: 'top' | 'middle' | 'bottom', offset?: mxPoint, cursor?): mxCellOverlay;
	}
/**
...
export class mxCellOverlay extends mxEventSource {
	constructor(image: mxImage, tooltip?: string, 
		align?: 'left' | 'center' | 'right', verticalAlign?: 'top' | 'middle' | 'bottom', offset?: mxPoint, cursor?);
	// {
	// 	this.image = image;
	 ...
	 * center of the edge.
	 */
	align: 'left' | 'center' | 'right'; //mxConstants.ALIGN_RIGHT
	 ...
	 * center of the edge.
	 */
	verticalAlign: 'top' | 'middle' | 'bottom'; //mxConstants.ALIGN_BOTTOM
