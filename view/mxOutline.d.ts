declare module "mxgraphAllClasses" {
	interface mxOutlineConstructor {
		new (source: mxGraph, container: Node): mxOutline;
	}
/**
...
export class mxOutline {
	constructor(source: mxGraph, container: Node)
	// {
	// 	this.source = source;
	 ...
	 */
	forceVmlHandles: boolean; //document.documentMode == 8
	 ...
	 */
	createGraph(container: Node): mxGraph;
	// {
	 ...
	 */
	init(container: Node): boolean | void;
	// {
	 ...
	 */
	createSizer(): mxImageShape | mxRectangleShape;
	// {
	 ...
	 */
	getOutlineOffset(scale: number): null;
	// {
	// 	return null;
	// };
	 ...
	 * (end)
	 */
	getTranslateForEvent(me): mxPoint;
	// {
