...
export class mxGraphView extends mxEventSource {
	 ...
	 */
	lastForegroundHtmlNode: Node; //null
	 ...
	 */
	updateVertexState(state: mxCellState, geo): void;
	// {
	// 	var model = this.graph.getModel();
	// 	var pState = this.getState(model.getParent(state.cell));
	 ...
	 * Validates the given cell state.
	 */
	updateEdgeState(state: mxCellState, geo): void;
	// {
	 ...
	 */
	updateFixedTerminalPoint(edge: mxCellState, terminal: mxCellState, source: mxCellState, constraintc: mxConnectionConstraint): void;
	// {
	 ...
	 * constraint - <mxConnectionConstraint> that specifies the connection.
	 */
	getFixedTerminalPoint(edge: mxCellState, terminal: mxCellState, source: mxCellState, constraint: mxConnectionConstraint): mxPoint;
	// {
	// 	var pt = null;
	 ...
	 */
	updateBoundsFromStencil(state: mxCellState): mxRectangle | null;
	// {
	// 	var previous = null;
	 ...
	 */
	transformControlPoint(state: mxCellState, pt: mxPoint): mxPoint | null;
	// {
	 ...
	 */
	getPerimeterPoint(terminal: mxCellState, next: mxPoint, orthogonal: boolean, border?): mxPoint;
	// {
	// 	var point = null;
	 ...
	 */
	createHtmlPane(width: number, height: number): HTMLElement;
	// {
	 ...
	 */
	createVmlPane(width: number, height: number): HTMLElement;
	// {
	 ...
	 */
	updateContainerStyle(container): void;
	// {
	 ...
	 */
	// TO DO
	// What do with this class??
	// function mxCurrentRootChange(view, root): void
	// {
	// 	this.view = view;
	// 	this.root = root;
	// 	this.previous = root;
