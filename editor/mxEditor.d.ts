...
// mxEditor.prototype.constructor = mxEditor; //mxEditor
 ...
 * is 'askZoom'.
 */
askZoomResource: string; //(mxClient.language != 'none') ? 'askZoom' : ''
 ...
 */
lastSavedResource: string; //(mxClient.language != 'none') ? 'lastSaved' : ''
 ...
 * Default is 'lastSaved'.
 */
currentFileResource: string; //(mxClient.language != 'none') ? 'currentFile' : ''
 ...
 */
propertiesResource: string; //(mxClient.language != 'none') ? 'properties' : ''
 ...
 */
tasksResource: string; //(mxClient.language != 'none') ? 'tasks' : ''
 ...
 */
helpResource: string; //(mxClient.language != 'none') ? 'help' : ''
 ...
 */
outlineResource: string; //(mxClient.language != 'none') ? 'outline' : ''
 ...
 * popupmenus.
 */
popupHandler: mxDefaultPopupMenu | null; //null
 ...
 */
undoManager: mxUndoManager | null; //null
 ...
 */
keyHandler: mxDefaultKeyHandler | null; //null
 ...
 */
cycleAttributeName: string | null; //'fillColor'
 ...
 */
helpWindowImage: string | null; //null
 ...
 */
configure (node: HTMLElement): void;
// {
// 	if (node != null)
// 	{
 ...
 * (end)
 */
addAction (actionname: string, funct): void;
// {
 ...
 * (end)
 */
execute (actionname: string, cell: mxCell, evt): void;
// {
 ...
 */
addTemplate (name: string, template): void;
// {
 ...
 */
readGraphModel (node: HTMLElement): void;
// {
// 	var dec = new mxCodec(node.ownerDocument);
 ...
 * (end)
 */
save (url: string, linefeed: string): void;
// {
 ...
 * (end)
 */
postDiagram (url: string, data): void;
// {
 ...
 */
refreshTasks (div: HTMLDivElement): void;
// {
// 	if (this.tasks != null)
// 	{
 ...
 */
createTasks (div: HTMLDivElement): void;
// {
// 	// override
// };
 ...
 * <setToolbarContainer>.
 */
createPopupMenu (menu, cell: mxCell, evt): void;
// {
 ...
 * specified cell.
 */
consumeCycleAttribute (cell: mxCell): boolean;
// {
 ...
 */
addVertex (parent, vertex, x: number, y: number);
// {
// 	var model = this.graph.getModel();
