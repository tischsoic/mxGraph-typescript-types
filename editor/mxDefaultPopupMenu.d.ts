 ...
 */
createMenu(editor: mxEditor, menu: mxPopupMenu, cell?: mxCell, evt?): void;
// {
// 	if (this.config != null)
// 	{
 ...
 */
addItems(editor: mxEditor, menu: mxPopupMenu, cell?: mxCell, evt?, conditions?: [boolean], item?, parent?): void;
// {
 ...
 * Default is true.
 */
addAction(menu: mxPopupMenu, editor: mxEditor, lab: string, icon?: string, funct?, action?: string, cell?: mxCell, parent?, iconCls?: string, enabled?: boolean);
// {
 ...
 */
createConditions(editor: mxEditor, cell: mxCell, evt): boolean[];
// {
