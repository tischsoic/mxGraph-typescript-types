 ...
 */
addItem(title: string, icon: string, action, pressed?: string);
// {
 ...
 */
addOption(combo: HTMLSelectElement, title: string, value): HTMLOptionElement;
// {
 ...
 * selected.
 */
addMode(title: string, icon: string, mode: string, pressed?: string, funct?): HTMLImageElement;
// {
// 	var clickHandler = mxUtils.bind(this, function()
// 	{
 ...
 * Default is true.
 */
addPrototype(title: string, icon: string, ptype, pressed?: string, insert?, toggle?: boolean): HTMLImageElement | HTMLButtonElement;
// {
 ...
 */
drop(vertex: mxCell, evt, target?: mxCell): void;
// {
 ...
 */
insert(vertex: mxCell, evt, target?: mxCell);
// {
// 	var graph = this.editor.graph;
 ...
 */
connect(vertex: mxCell, evt, source?: mxCell): void;
// {
// 	var graph = this.editor.graph;
// 	var model = graph.getModel();
 ...
 */
installDropHandler (img: HTMLImageElement, dropHandler): void;
// {
