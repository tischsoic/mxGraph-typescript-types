declare module "mxgraphAllClasses" {
	interface mxGraphModelConstructor {
 ...
 */
getNearestCommonAncestor(cell1: mxCell, cell2: mxCell): mxCell | null;
// {
 ...
 */
getTerminal(edge: mxCell, isSource: boolean): mxCell | null;
// {
 ...
 * to return.
 */
getEdgeAt(cel: mxCell, index: number): mxCell | null;
// {
 ...
 * (end) 
 */
valueForCellChanged(cell: mxCell, value);
// {
 ...
 * the new cell style.
 */
styleForCellChanged(cell: mxCell, style);
// {
 ...
 */
mergeChildrenImpl(from: mxCell, to: mxCell, cloneAllEdges: boolean, mapping): void;
// {
// 	this.beginUpdate();
// 	try
// 	{
 ...
 */
cloneCell(cell: mxCell): mxCell | null;
// {
// 	if (cell != null)
// 	{
 ...
 */
cloneCells(cells: [mxCell], includeChildren: boolean, mapping): [mxCell];
// {
 ...
 */
cloneCellImpl(cell: mxCell, mapping, includeChildren: boolean): mxCell;
// {
 ...
 */
restoreClone(clone: mxCell, cell: mxCell, mapping): void;
// {
...
export class mxTerminalChange {
	constructor(model, cell: mxCell, terminal: mxCell, source);
// {
// 	this.model = model;
// 	this.cell = cell;
