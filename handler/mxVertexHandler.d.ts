 ...
 */
isCenteredEvent(state, me): boolean;
// {
// 	return false;
// };
 ...
 * border.
 */
getSelectionBounds(state): mxRectangle;
// {
 ...
 * Creates the shape used to draw the selection border.
 */
createSelectionShape(bounds): mxRectangleShape;
// {
 ...
 */
moveSizerTo(shape, x: number, y: number): void;
// {
// 	if (shape != null)
// 	{
 ...
 */
isCustomHandleEvent(me): boolean;
// {
// 	return true;
// };
 ...
 */
start(x: number, y: number, index): void;
// {
 ...
 */
isRecursiveResize(state, me): boolean;
// {
 ...
 */
rotateCell(cell: mxCell, angle: number, parent): void;
// {
// 	if (angle != 0)
// 	{
 ...
 */
resizeCell(cell: mxCell, dx: number, dy: number, index, gridEnabled: boolean, constrained, recurse): void;
// {
 ...
 * (end)
 */
union(bounds, dx: number, dy: number, index, gridEnabled: boolean, scale, tr, constrained, centered);
// {
// 	if (this.singleSizer)
// 	{
