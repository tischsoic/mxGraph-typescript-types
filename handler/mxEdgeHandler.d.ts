 ...
 */
isVirtualBendsEnabled(evt): boolean;
// {
 ...
 * implementation returns true if shift is pressed.
 */
isRemovePointEvent(evt): boolean;
// {
// 	return mxEvent.isShiftDown(evt);
// };
 ...
 */
getSelectionPoints(state): mxPoint[];
// {
 ...
 */
createParentHighlightShape(bounds): mxRectangleShape;
// {
 ...
 * Creates the shape used to draw the selection border.
 */
createSelectionShape(points: mxPoint[]);
// {
 ...
 */
getCellAt(x: number, y: number): mxCell | null;
// {
 ...
 */
createHandleShape(index: number): mxImageShape | mxRectangleShape;
// {
 ...
 */
createLabelHandleShape(): mxImageShape | mxRectangleShape;
// {
 ...
 */
initBend(bend: mxShape, dblClick): void | false;
// {
// 	if (this.preferHtml)
// 	{
 ...
 */
getPreviewPoints(pt: mxPoint, me?): mxPoint[] | null;
// {
 ...
 * or shift is pressed.
 */
isOutlineConnectEvent(me): boolean;
// {
 ...
 * Updates the given preview state taking into account the state of the constraint handler.
 */
updatePreviewState(edge: mxCell, point: mxPoint, terminalState, me, outline): void;
// {
 ...
 */
moveLabel(edgeState, x: number, y: number): void;
// {
// 	var model = this.graph.getModel();
 ...
 */
addPointAt(state, x: number, y: number): void;
// {
 ...
 */
removePoint(state, index: number): void;
// {
