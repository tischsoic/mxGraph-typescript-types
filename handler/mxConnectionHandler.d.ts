 ...
 */
connectIconOffset: mxPoint; //new mxPoint(0, mxConstants.TOOLTIP_VERTICAL_OFFSET)
 ...
 */
movePreviewAway: boolean; //mxClient.IS_VML
 ...
 * released.
 */
isInsertBefore(edge: mxCell, source: mxCell, target: mxCell, evt, dropTarget: mxCell): boolean;
// {
 ...
 */
start(state, x: number, y: number, edgeState): void;
// {
// 	this.previous = state;
 ...
 */
getConnectImage(state: mxCellState);
// {
 ...
 */
redrawIcons(icons?: mxImageShape[], state?): void;
// {
 ...
 * icons - Optional array of <mxImageShapes> to be redrawn.
 */
getIconPosition(icon: mxImageShape[], state): mxPoint;
// {
 ...
 * in the graph. 
 */
isImmediateConnectSource(state): boolean;
// {
 ...
 * the <marker>.
 */
updateCurrentState(me, point: mxPoint): void;
// {
 ...
 */
snapToPreview(me, point: mxPoint): void;
// {
 ...
 * Updates <edgeState>.
 */
updateEdgeState(current, constraint): void;
// {
 ...
 */
getTargetPerimeterPoint(state: mxCellState, me);
// {
// 	var result = null;
// 	var view = state.view;
 ...
 * me - <mxMouseEvent> that represents the mouse move.
 */
getSourcePerimeterPoint(state: mxCellState, next: mxPoint, me: mxMouseEvent);
// {
// 	var result = null;
// 	var view = state.view;
 ...
 */
updateIcons(state: mxCellState, icons, me): void;
// {
// 	// empty
// };
 ...
 * released.
 */
connect(source: mxCell, target: mxCell, evt, dropTarget: mxCell): void;
// {
 ...
 */
insertEdge(parent, id, value, source, target, style): void;
// {
 ...
 * source - <mxCell> that represents the source terminal.
 */
createTargetVertex(evt, source: mxCell);
// {
 ...
 */
getAlignmentTolerance(evt): number;
// {
 ...
 */
createEdge(value, source: mxCell, target: mxCell, style): mxCell;
// {
// 	var edge = null;
