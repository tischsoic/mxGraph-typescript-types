declare module "mxgraphAllClasses" {
	interface mxKeyHandlerConstructor {
		new(graph: mxGraph, target?: HTMLElement): mxKeyHandler;
	}
	/**
	...
	export class mxKeyHandler {
		constructor(graph: mxGraph, target?: HTMLElement);
		// {
		// 	if (graph != null)
		// 	{
		// 		this.graph = graph;
		 ...
		 * funct - JavaScript function that takes the key event as an argument.
		 */
		bindControlKey(code: number, funct): void;
		// {
		 ...
		 * funct - JavaScript function that takes the key event as an argument.
		 */
		bindControlShiftKey(code: number, funct): void;
		// {
