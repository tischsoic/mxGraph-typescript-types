 ...
 */
updatePreviewState(edge: mxCell, point: mxPoint, terminalState, me): void;
// {
 ...
 */
connect(edge: mxCell, terminal: mxCell, isSource: boolean, isClone: boolean, me): mxCell;
// {
