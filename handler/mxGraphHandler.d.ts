 ...
 * 500.
 */
maxCells: number; //(mxClient.IS_IE) ? 20 : 50
 ...
 */
isDelayedSelection(cell: mxCell, me): boolean;
// {
 ...
 * </code>
 */
consumeMouseEvent(evtName, me): void;
// {
// 	me.consume();
// };
 ...
 */
createPreviewShape(bounds): mxRectangleShape;
// {
 ...
 * mousereleased event.
 */
shouldRemoveCellsFromParent(parent, cells: mxCell[], evt): boolean;
// {
 ...
 */
moveCells(cells: mxCell[], dx: number, dy: number, clone, target, evt): void;
// {
// 	if (clone)
// 	{
